const translations = {
  ...
  en: {
    ...
    "hero-title":
      "Interfaces with <span class='highlight'>presence</span>, code with consistency.",
    "hero-desc":
      "Building high-standard interfaces with a focus on usability, performance, and visual impact.",
    "hero-note":
      "Digital experiences with visual presence, clear navigation, and responsive execution.",
    ...
    "skills-panel-text":
      "Each block is arranged to show technical mastery, visual clarity, and delivery consistency.",
    "proj-sub": "Portfolio",
    "proj-title": "Project <span class='highlight-cyan'>Gallery</span>",
    "projects-lead":
      "A selection of interfaces, systems, and experiences built with performance, navigation, and presentation in mind.",
    "contact-sub": "Contact",
    "contact-title": "Let's build something <span class='highlight'>new?</span>",
    "contact-desc": "Jaragua do Sul, Brazil | Remote work available.",
    "ph-name": "Name",
    "ph-email": "Email",
    "ph-msg": "Your message...",
    "btn-send": "Prepare Email",
    "sending": "Preparing...",
    "message-sent": "Your email app will be opened.",
    "message-retry": "Could not prepare the email.",
    ...
    "proj-valthan":
      "High-performance institutional website developed for a metallurgical industry specialized in CNC solutions.<br><strong>Industrial Interface</strong>: Modern design focused on showcasing services like Turning and Laser Cutting.<br><strong>B2B Conversion</strong>: Optimized flows for quote requests and direct contact.<br><strong>SEO & Performance</strong>: Lightweight structure optimized for search engines, targeting the regional market.<br><strong>Website:</strong> <a href='https://valthan.com.br/' target='_blank' rel='noopener noreferrer'>https://valthan.com.br/</a>",
    "proj-divulga":
...
function projectPreview(projectId, maxLength = 210) {
...
function renderProjects() {
  ...
  grid.innerHTML = allProjects.map((project, index) => `
    <article class="showcase-row reveal ${index % 2 !== 0 ? "reverse" : ""}">
...
function initSectionObserver() {
  ...
  const items = document.querySelectorAll(".nav-links a[data-section]");
...
function openProjectModal(projectId) {
  ...
  body.innerHTML = `
    ...
    <div class="gallery-wrapper">
      ...
      <button class="nav-arrow right" id="nextBtn" onclick="scrollGallery(1)" aria-label="Proxima imagem">❯</button>
    </div>
  `;
  ...
  const gallery = document.getElementById("modalGallery");
  if (gallery) gallery.addEventListener("scroll", updateArrows, { passive: true });
...
function initLanguageSwitch() {
  ...
  const desktop = document.getElementById("lang-switch");
  const mobile = document.getElementById("lang-switch-mobile");
  if (desktop) desktop.onclick = toggle;
  if (mobile) mobile.onclick = toggle;
}
...
function initForm() {
  ...
  form.addEventListener("submit", (event) => {
    ...
    try {
      ...
      window.location.href = `mailto:jeansilvax1697@gmail.com?subject=${subject}&body=${body}`;
